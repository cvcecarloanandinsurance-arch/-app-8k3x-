...
// (Market_Status_v3.html / sw-v2.js / market-status-manifest-v3.json) —
...
const CORE_ASSETS = [
  "./Market_Status_v3.html",
  "./market-status-manifest-v3.json",
  "./market-status-icon-192-v3.png",
  "./market-status-icon-512-v3.png"
];
